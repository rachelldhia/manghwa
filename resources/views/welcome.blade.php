...
<body>
    <header>
        <nav>
            ...
            <div>
                <ul>
                    <li><a class="btn" href="{{route('admin')}}">Dashboard</a></li>
                </ul>
            </div>
            @endguest
    ...
    {{-- <footer>
        ...
        <div>
            ...
            <a class="btn" href="{{url('/manga')}}">Register</a>
        </div>
        @endguest
        ...
        <div>
            ...
            <ul id="socials">
                ...
                <li><a href="https://github.com/syiffanoriza"><img src="{{asset('assets/images/github.png')}}"></a></li>a --}}
            </ul>
        </div>
    </footer>
</body>
